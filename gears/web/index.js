...
(() => {
    ...
    const config = JSON.parse(`{
        ...
        "catalog": {
            "Base": "sys.core.Base",
            "Boot": "sys.boot.Server | sys.boot.Client",
    ...
    Object.assign(config.env.require.bundles, JSON.parse('{"gears/modules/aop":["sys.aop.Base"],"gears/modules/boot":["sys.boot.Client","sys.boot.Server"],"gears/modules/core":["sys.core.Base","sys.core.Module"]}'));
