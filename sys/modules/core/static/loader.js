...
(() => {
    ...
    // base config
    const config = JSON.parse(`{"settings":{"app":{"title":"My Application","version":"1.0.0","edition":"alpha","copyright":"Ⓒ xxxx, ...","tagline":"...","desc":"...","url":"...","org":"..."},"main":"app.sample | web.sample","routes":{"server":[],"client":[]},"xLog":"silly","minify":false,"docs":false,"source":{"sys":"sys/modules/","web":"web/modules/","app":"app/modules/"}},"sys.core":{"catalog":{"IBootware":"sys.core.boot.IBootware","IApp":"sys.core.app.IApp","Base":"sys.core.Base","ErrorInfo":"sys.core.ErrorInfo","Dto":"sys.core.domain.Dto","AuthInfo":"sys.core.security.AuthInfo","Credentials":"sys.core.security.Credentials","User":"sys.core.security.User","ClaimsChecker":"sys.core.security.ClaimsChecker","ValueValidator":"sys.core.data.ValueValidator","Hash":"sys.core.security.Hash","ServiceAdapter":"sys.core.comm.ServiceAdapter","Bootstrapper":"app.core.boot.Server | web.core.boot.Client","App":"app.core.app.ServerApp | web.core.app.ClientApp","Auth":"app.core.security.Auth | web.core.security.Auth"},"container":{},"api":{"root":"/api","version":"v"},"locales":{"default":"en-us","supported":{"en-us":{"lcid":"1033","display":"English (United States)","rtl":false}}},"static":{"favIcon":"web/sample/static/favicon.ico"},"view":{"login":"#/login"}},"web.core":{"catalog":{"Binder":"web.core.ui.Binder","Formatter":"web.core.ui.Formatter","Adapter":"web.core.ui.Adapter","Transition":"web.core.ui.Transition","DataBinder":"web.core.bootwares.DataBinder","ComponentTypes":"web.core.ui.ComponentTypes","Component":"web.core.ui.Component","View":"web.core.ui.View","Shell":"web.core.ui.Shell","Partial":"web.core.ui.Partial"},"routes":{"client":[]},"dependencies":[],"bootwares":["sys.core.bootwares.Attributes","web.core.bootwares.Dependencies","sys.core.bootwares.Router","sys.core.bootwares.ErrorHandler","sys.core.bootwares.Locales","[DataBinder]"],"more":{"bootwares":[],"dependencies":[]},"rivets":{"config":{},"formatters":["web.core.ui.formatters.Percent"],"binders":["web.core.ui.binders.xClass"],"adapters":[]},"view":{"$stage":"#stage","$container":"#container","login":"#/login"}},"web.sample":{"routes":{"client":[{"url":"/","class":"web.sample.views.Home"},{"url":"/view1","class":"web.sample.views.View1"},{"url":"/view2","class":"web.sample.views.View2"}]}},"app.core":{"catalog":{"TokenManager":"app.core.security.TokenManager","Crypt":"app.core.security.Crypt","Service":"app.core.comm.Service","Controller":"app.core.domain.Controller","Entity":"app.core.domain.Entity","DbContext":"app.core.data.DbContext","Repository":"app.core.data.Repository","UnitOfWork":"app.core.data.UnitOfWork","Automapper":"app.core.data.Automapper"},"container":{},"routes":{"server":[{"ver":"1","root":"/","url":"/auth","verb":"post","class":"app.core.security.Auth","func":"login"}]},"express":{"case sensitive routing":false,"strict routing":false},"server":{"http":{"enable":true,"port":8080,"timeout":-1},"https":{"enable":false,"port":8443,"timeout":-1,"ssl":{"public":"./cert.pem","private":"./key.pem"}}},"response":{"headers":[{"name":"Access-Control-Allow-Credentials","value":true},{"name":"Access-Control-Allow-Origin","value":"*"},{"name":"Access-Control-Allow-Methods","value":"GET, PUT, POST, DELETE"},{"name":"Access-Control-Allow-Headers","value":"X-Requested-With, X-HTTP-Method-Override, Content-Type, Accept, Request"}]},"bootwares":["sys.core.bootwares.Attributes","app.core.bootwares.Middlewares","sys.core.bootwares.Router","app.core.bootwares.StaticServer","app.core.bootwares.LocalTunnel","sys.core.bootwares.ErrorHandler","sys.core.bootwares.Locales"],"middlewares":[{"name":"compression"},{"name":"cookie-parser"},{"name":"express-bearer-token"},{"name":"body-parser","func":"urlencoded","args":[{"extended":true}]},{"name":"body-parser","func":"json"}],"more":{"response":{"headers":[]},"bootwares":[],"middlewares":[]},"localtunnel":{"enable":false,"subdomain":"appgears","localhost":"localhost","port":8080},"static":{"favIcon":"","caching":{"enable":true,"age":86400000}},"security":{"crypt":{"secretKey":"adfdef1d-ce1a-470d-a652-f466292acf85"},"jwt":{"secretKey":"adfdef1d-ce1a-470d-a652-f466292acf85","expiresInMinutes":30}}},"app.sample":{"routes":{"server":[]}}}`);
    ...
    config.env = {
        ...
        isMobile: false,
        isTablet: false,
        lupdate: 'Sat, 02 Sep 2017 16:31:30 GMT',         
        isDev: false,
        isProd: true,
        isTest: false,
        isReady: false,
    ...
    if (!config.env.isDev) { // dev mode get files as is from server, instead of bundles, as there are no bundles
        ...
        Object.assign(config.env.require.bundles, JSON.parse('{"sys/core":["sys.core.Base","sys.core.ErrorInfo","sys.core.boot.IBootware","sys.core.bootwares.Attributes","sys.core.bootwares.ErrorHandler","sys.core.bootwares.Locales","sys.core.bootwares.Router","sys.core.comm.ClientRequest","sys.core.comm.ClientResponse","sys.core.comm.Handler","sys.core.comm.Request","sys.core.comm.Response","sys.core.comm.ServiceAdapter","sys.core.data.ValueValidator","sys.core.domain.Dto","sys.core.security.AuthInfo","sys.core.security.ClaimsChecker","sys.core.security.Credentials","sys.core.security.Hash","sys.core.security.User","sys.core.app.App","sys.core.app.IApp"],"web/core":["web.core.app.ClientApp","web.core.boot.Client","web.core.bootwares.DataBinder","web.core.bootwares.Dependencies","web.core.security.Auth","web.core.ui.Adapter","web.core.ui.Binder","web.core.ui.Component","web.core.ui.ComponentTypes","web.core.ui.Formatter","web.core.ui.Partial","web.core.ui.Shell","web.core.ui.Transition","web.core.ui.View","web.core.ui.binders.xClass","web.core.ui.formatters.Percent"],"web/sample":["web.sample.partials.SimpleList","web.sample.shells.Full","web.sample.views.Home","web.sample.views.View1","web.sample.views.View2"]}'));
    }
