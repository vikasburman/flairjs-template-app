...
// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/Base.js)
define('sys.core.Base', [use('[ErrorInfo]')], function (ErrorInfo) {
    /**
     * @class sys.core.Base
    ...
    return Class('sys.core.Base', function (attr) {
        ...
        attr('protected');
        this.func('onError', function (err, ctx) {
            if (!ctx) {
                ctx = '';
            }
            var message = '*** Error in ' + _this._.name + ' ***' + (ctx ? '\n' + ctx : ''),
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/Base.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/ErrorInfo.js)
define('sys.core.ErrorInfo', function () {
    ...
    return Class('sys.core.ErrorInfo', function (attr) {
        ...
        this.func('constructor', function (code, desc, details, raw) {
            _this.isServerError = config.env.isServer;
            _this.code = config.env.isServer ? '500' : '5000';
            if (code._ && code._.name === _this._.name) {
                // ErrorInfo class
                _this.code = code.code;
                _this.desc = code.desc;
                _this.details = code.details;
                _this.raw = code.raw;
                _this.stack = code.stack || console.trace();
            } else if (code && desc && details && raw) {
                _this.code = code;
                _this.desc = desc;
                _this.details = details;
                _this.raw = raw;
                _this.stack = console.trace();
                ...
                _this.desc = desc || code.toString();
                _this.details = details || '';
                _this.raw = raw || '';
                _this.stack = console.trace();
            } else {
                // some other error object
                _this.raw = code;
                _this.code = code.status || code.code || _this.code;
                _this.desc = code.statusText || code.desc || code.toString() || '';
                _this.details = code.details || '';
                _this.stack = code.stack || code.responseText || console.trace();
            }
            if (config.env.isProd && !config.env.isServer) {
                _this.stack = '';
            }
        });
        ...
        this.func('getText', function () {
            return 'Error: [' + _this.code + '] ' + _this.desc + ' ' + (_this.details ? '\n' + _this.details : '') + ' ' + (_this.stack ? '\n' + _this.stack : '');
        });
    });
});
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/ErrorInfo.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/app/App.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/app/App.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/app/IApp.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/app/IApp.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/boot/IBootware.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/boot/IBootware.js)
'use strict';

function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/bootwares/Attributes.js)
        ...
        this.func('boot', function (resolve, reject, app) {
            ...
            Container.register(Class('poll', Attribute, function () {
                ...
                this.decorator(function (obj, type, name, descriptor) {
                    // validate
                    if (['func'].indexOf(type) === -1) {
                        throw 'poll attribute cannot be applied on ' + type + ' members. (' + name + ')';
                    }
                    if (['_constructor', '_dispose'].indexOf(type) !== -1) {
                        throw 'poll attribute cannot be applied on special function. (' + name + ')';
                    }

                    // decorate
                    var interval = _this3.args[0] || 0,
                        ms = interval * 1000,
                        fn = descriptor.value,
                        intervalHandle = null;
                    descriptor.value = function () {
                        if (!intervalHandle) {
                            // set interval on first call
                            if (ms < 0) {
                                ms = 1;
                            } // min is set as 1 millisecond
                            var isRunning = false;
                            ...
                            intervalHandle = setInterval.apply(undefined, [wrappedFn, ms].concat(args));
                            xLog('debug', 'Poll ' + obj._.name + '.' + name + ' activated to run every ' + ms + ' ms.');
                        } else {
                            // clear interval on second call
                    ...
                    descriptor.value = function (resolve, reject, request) {
                        ...
                        if (claims) {
                            ...
                            auth.validate(request).then(onAuth).catch(function (err) {
                                if (_this5.env.isServer) {
                                    _this5.onError(err, 'Failed to authenticate ' + request.url + '.');
                                    request.response.send.error(401, err);
                                } else {
                                    _this5.onError(err, 'Failed to authenticate ' + document.location.hash + '.');
            ...
            Container.register(Class('check', Attribute, function () {
                ...
                this.decorator(function (obj, type, name, descriptor) {
                    ...
                    // decorate
                    var validations = _this6.args || null,
            ...
            if (_this7.env.isServer) {
                ...
                Container.register(Class('job', Attribute, function () {
                    ...
                    this.decorator(function (obj, type, name, descriptor) {
                        // validate
                        if (['func'].indexOf(type) === -1) {
                            throw 'job attribute cannot be applied on ' + type + ' members. (' + name + ')';
                        }
                        if (['_constructor', '_dispose'].indexOf(type) !== -1) {
                            throw 'job attribute cannot be applied on special function. (' + name + ')';
                        }

                        // decorate
                        var schedule = _this8.args[0] || '* * * * * *',
                            timeZone = _this8.args[1] || '',
                            fn = descriptor.value,
                            job = null,
                            CronJob = require('cron').CronJob;
                        if (!schedule) {
                            schedule = '* * * * * *';
                        } // defaults to run every second
                        var opts = {
                            cronTime: schedule,
                            onTick: null,
                            start: false,
                        ...
                        descriptor.value = function () {
                            if (!job) {
                                // set job on first call
                                var isRunning = false;
                                opts.onTick = function () {
                                    if (!isRunning) {
                                        var onDone = function onDone() {
                                            isRunning = false;
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/bootwares/Attributes.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/bootwares/ErrorHandler.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/bootwares/ErrorHandler.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/bootwares/Locales.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/bootwares/Locales.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/bootwares/Router.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/bootwares/Router.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/ClientRequest.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/ClientRequest.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/ClientResponse.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/ClientResponse.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/Handler.js)
define('sys.core.comm.Handler', [use('[Base]')], function (Base) {
    ...
    return Class('sys.core.comm.Handler', Base, function (attr) {
        ...
        this.func('handle', function (request) {
            var errorText = !_this.env.isServer ? 'Error handling: ' + request.url + '#' + request.verb + '.' : 'Error handling: ' + request.url + '.';
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/Handler.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/Request.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/Request.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/Response.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/Response.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/ServiceAdapter.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/comm/ServiceAdapter.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/data/ValueValidator.js)
define('sys.core.data.ValueValidator', [use('[Base]')], function (Base) {
    /**
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/data/ValueValidator.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/domain/Dto.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/domain/Dto.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/Auth.js)
define('sys.core.security.Auth', [use('[Base]'), use('[User]'), use('[ClaimsChecker]')], function (Base, User, ClaimsChecker) {
    /**
    ...
    return Class('sys.core.security.Auth', Base, function (attr) {
        ...
        this.func('login', function (service, resolve, reject) {
            var loginId = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
            var pwd = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '';
            var clientId = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : '';

            var credentials = App.auth(loginId, pwd, clientId);
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/Auth.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/AuthInfo.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/AuthInfo.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/ClaimsChecker.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/ClaimsChecker.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/Credentials.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/Credentials.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/Hash.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/Hash.js)
'use strict';

// START: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/User.js)
...
// END: (/Users/vikasburman/Data/Projects/GitHub/appgears/source/sys/modules/core/members/security/User.js)